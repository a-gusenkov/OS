...
public class pidManager {
  ...
  public int allInt;
    ...
    //So that the arrayList indexes reflect the Pid Map indexes.
		int int_true_pid = int_pid + MIN_PID;
		...
		else if(int_true_pid < MIN_PID || int_true_pid > MAX_PID) {
    ...
    //int_pid is subtracted by MIN_PID
      ...
      //is represented by 0
		else if (pids.get(int_true_pid - MIN_PID) == 0) {
      ...
      //is represented by 0
      System.out.println (pids.toString());
			pids.set(int_true_pid - MIN_PID, 0);
			System.out.println("The pid at index this following is released:" + int_true_pid);
			return int_true_pid;
		}
	}
